...
@Service
public class UploadStreamV5Service {

    private final Logger logger = LoggerFactory.getLogger(UploadStreamV5Service.class);
    ...
    private void updateStatusAndRetries(UploadStreamTracker fileTracker, S3TransferManager transferManager,
        ...
        try {
            CompletedUpload result= upload.completionFuture().get();
